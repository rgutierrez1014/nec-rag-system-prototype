...
.PHONY: start-dev stop-dev logs tunnel tunnel-kill tunnel-restart api frontend status setup-api setup-db apply-migrations verify verify-infra verify-npi test ingest-npi
